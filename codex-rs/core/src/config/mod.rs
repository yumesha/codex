...
use crate::config_loader::McpServerIdentityRequirement;
...
fn filter_mcp_servers_by_allowlist(
    ...
    allowlist: Option<&BTreeMap<String, McpServerIdentityRequirement>>,
) {
...
fn constrain_mcp_servers(
    ...
    Constrained::normalized(mcp_servers, move |mut servers| {
        filter_mcp_servers_by_allowlist(&mut servers, allowlist.as_ref());
        servers
    })
}

fn mcp_server_matches_requirement(
    requirement: &McpServerIdentityRequirement,
    ...
    match requirement {
        ...
        McpServerIdentityRequirement::Url { url: want_url } => matches!(
            &server.transport,
...
impl Config {
    ...
    fn load_config_with_layer_stack(
        ...
        let mcp_servers =
            constrain_mcp_servers(cfg.mcp_servers.clone(), mcp_server_allowlist.as_ref()).map_err(
...
"#,
    ...
    fn filter_mcp_servers_by_allowlist_allows_all_when_unset() {
        ...
        filter_mcp_servers_by_allowlist(&mut servers, None);
    ...
    fn filter_mcp_servers_by_allowlist_blocks_all_when_empty() {
        ...
        filter_mcp_servers_by_allowlist(&mut servers, Some(&BTreeMap::new()));
